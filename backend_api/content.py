TEAM_MEMBERS = [
    {
        ...
        "summary": "Guides the academic direction, research framing, and evaluation strategy behind the grading platform.",
    },
    {
        "name": "Yuvraj Verma",
        "branch": "Electronics",
        ...
        "github": "https://github.com/vermayuvraj",
        "website": "https://www.yuvrajverma.me/",
        "summary": "Leading the AI workflow integration across OCR, semantic grading, and the product-facing system experience.",
    },
    {
        ...
        "summary": "Supports model experimentation, scoring quality improvements, and AI pipeline refinement for reliable evaluation.",
    },
    {
        ...
        "summary": "Focuses on research validation, documentation quality, and keeping the final product presentation polished and clear.",
    },
]
...
RESOURCE_ITEMS = [
    {
        ...
        "purpose": "Product-facing website and research-facing dashboard interfaces.",
    },
    {
        "category": "Backend API",
        "name": "FastAPI",
        "purpose": "Upload APIs, evaluation orchestration, and report download endpoints.",
    },
    {
        "category": "OCR",
        "name": "EasyOCR",
    ...
    },
    {
        ...
        "purpose": "Semantic similarity scoring for descriptive answers.",
    },
    {
        "category": "Diagram Evaluation",
        "name": "CLIP ViT-B/32",
        "purpose": "Visual comparison between ideal and student diagrams.",
    },
    {
        "category": "Formula Evaluation",
        "name": "pix2tex + SymPy",
        "purpose": "Equation OCR and symbolic mathematical equivalence checking.",
    },
    {
        "category": "LLM Evaluation",
        "name": "Gemini 2.5 Flash",
        "purpose": "Rubric-aware LLM grading path.",
    },
]
